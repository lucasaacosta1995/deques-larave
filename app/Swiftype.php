...
class Swiftype {
	...
	public function __construct($username = "lucasaacosta1995@gmail.com", $password = "Lucaskpo123", $api_key = "nQe5UnwStbdUzKMDAoCA", $host = 'http://api.swiftype.com', $api_base_path = '/api/v1/') {
