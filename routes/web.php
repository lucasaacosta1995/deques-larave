...
Route::get('Proyecto/crearDocument/{document}','ProyectoController@crearDocument');
Route::get('Proyecto/deleteDocument/{document}','ProyectoController@deleteDocument');
